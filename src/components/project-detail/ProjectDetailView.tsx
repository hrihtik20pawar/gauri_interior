...
export default function ProjectDetailView({ project, backLink, backLabel, heroHeight = 'h-[60vh] min-h-[500px]', showMoreViews = false }: ProjectDetailViewProps) {
  if (!project) {
      ...
      <div className={`relative ${heroHeight} w-full`}>
        ...
        <div className="absolute inset-0 flex items-end">
          <div className="max-w-[1500px] mx-auto w-full px-6 md:px-12 lg:px-24 pb-16">
            <Link to={backLink} className="inline-flex items-center gap-2 text-white/80 hover:text-white transition-colors mb-6 font-medium text-sm bg-white/10 backdrop-blur-md px-4 py-2 rounded-full border border-white/20">
